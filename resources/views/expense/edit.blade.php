        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            {!! Form::open(['url' => action('ExpenseController@update', $expense->id), 'method' => 'put', 'enctype' =>
                            'multipart/form-data']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('expense_category_id', $expense_categories, $expense->expense_category_id, ['class' =>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('expense_beneficiary_id', $expense_beneficiaries, $expense->expense_beneficiary_id, ['class' => 'form-control selectpicker', 'data-live-search' => 'true',
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        $expense->source_id, ['class' => 'selectpicker form-control',
                                        'data-live-search'=>"true",
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="next_payment_date" id="next_payment_date" value="{{$expense->next_payment_date}}">
                                    </div>
                                </div>
                                <div class="col-md-4 mt-4 notify_field @if(empty($expense->next_payment_date)) hide @endif">
                                    <div class="i-checks">
                                        <input id="notify_me" name="notify_me" type="checkbox" @if($expense->notify_me) checked @endif value="1"
                                ...
                                <div class="col-md-4 notify_field @if(empty($expense->next_payment_date)) hide @endif">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="notify_before_days" id="notify_before_days"  value="{{$expense->notify_before_days}}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
