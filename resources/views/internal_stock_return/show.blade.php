                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <b>@if(!empty($transaction->approved_at)) {{@format_date($transaction->approved_at)}} @endif - {{$transaction->approved_by_user->name}}</b>
                            </div>

                            <div class="col-md-6">
                                {!! Form::label('receiver_store', __('lang.received'), []) !!}:
                                <b>@if(!empty($transaction->received_at)) {{@format_date($transaction->received_at)}} @endif - {{$transaction->received_by_user->name}}</b>
                            </div>
