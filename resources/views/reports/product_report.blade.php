                    ...
                    <table class="table dataTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{@num_format($transaction->sold_amount - $transaction->purchased_amount)}}</td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                            ...
                                            <li>
                                                ...
                                                <a href="{{action('ProductController@edit', $transaction->id)}}" class="btn"><i
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>{{@num_format($transactions->sum('sold_amount') - $transactions->sum('purchased_amount'))}}</th>
