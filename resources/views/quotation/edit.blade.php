                ...
                <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group my-group">
                                        ...
                                        'style' =>'width: 80%' , 'id' => 'customer_id', 'required']) !!}
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="i-checks">
                                    <input id="block_qty" name="block_qty" type="checkbox" @if($sale->block_qty) checked @endif value="1"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('block_for_days', $sale->block_for_days, ['class' => 'form-control', 'placeholder' => __(
                                'lang.block_for_days' ),
                                'required' ]);
                                !!}
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('validity_days', $sale->validity_days, ['class' => 'form-control', 'placeholder' => __(
                                'lang.validity_days' ),
                                'required' ]);
                                !!}
                            </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group my-group">
                                {!! Form::select('status', ['draft' => 'Draft', 'approved' => 'Approved', 'rejected' => 'Rejected', 'expired' => 'Expired', 'valid' => 'Valid'],
                                $sale->status, ['class' =>
                                'selectpicker form-control', 'data-live-search'=>"true",
