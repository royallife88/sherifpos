        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => action('PurchaseOrderController@update', $purchase_order->id), 'method' => 'put', 'id' =>
                    'purchase_order_form']) !!}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3  @if(!session('user.is_superadmin')) hide @endif">
                                <div class="form-group">
                                    ...
                                    $purchase_order->store_id, ['class' => 'selectpicker form-control', 'data-live-search'=>"true",
                                    'required',
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('po_no', $purchase_order->po_no, ['class' => 'form-control','required', 'readonly',
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input type="hidden" name="purchase_order_lines[{{$loop->index}}][product_id]" value="{{$product->product_id}}">
                                                <input type="hidden" name="purchase_order_lines[{{$loop->index}}][variation_id]" value="{{$product->variation_id}}">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                name="purchase_order_lines[{{$loop->index}}][quantity]" required value="@if(isset($product->quantity)){{$product->quantity}}@else{{1}}@endif">
                                            </td>
                                            <td>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-3 offset-md-8 text-right">
                                <h3> @lang('lang.total'): <span class="final_total_span">{{@num_format($purchase_order->final_total)}}</span> </h3>
                                <input type="hidden" name="final_total" id="final_total" value="{{$purchase_order->final_total}}">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('details', $purchase_order->details, ['class' => 'form-control', 'rows' => 3]) !!}
                                </div>
                            </div>
                        </div>
