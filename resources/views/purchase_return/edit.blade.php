                ...
                <div class="card-body">
                                    ...
                                    <table id="product_table" style="width: 100% " class="table table-striped">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th><span class="grand_total_span">{{@num_format($purchase_return->grand_total)}}</span>
                                                </th>
                                            </tr>
                                        </tfoot>
                                    </table>
                    ...
                    <div class="col-md-3 due_fields hide">
                        <div class="form-group">
                            ...
                            {!! Form::text('notify_me', !empty($purchase_return) ? $purchase_return->notify_me : null, ['class' =>
                            'form-control',
