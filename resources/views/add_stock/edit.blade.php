        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {!! Form::open(['url' => action('AddStockController@update', $add_stock->id), 'method' => 'put', 'id' =>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    $add_stock->store_id, ['class' => 'selectpicker form-control', 'data-live-search'=>"true",
                                    'required',
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                @endif
                                                <input type="hidden" name="add_stock_lines[{{$loop->index}}][add_stock_line_id]" value="{{$product->id}}">
                                                <input type="hidden" name="add_stock_lines[{{$loop->index}}][product_id]" value="{{$product->product_id}}">
                                                <input type="hidden" name="add_stock_lines[{{$loop->index}}][variation_id]" value="{{$product->variation_id}}">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                name="add_stock_lines[{{$loop->index}}][quantity]" required value="@if(isset($product->quantity)){{$product->quantity}}@else{{1}}@endif">
                                            </td>
                                            <td>
                                                <input type="text" class="form-control purchase_price"
                                                name="add_stock_lines[{{$loop->index}}][purchase_price]" required value="@if(isset($product->purchase_price)){{@num_format($product->purchase_price)}}@else{{0}}@endif">
                                            </td>
                                            <td>
                                                <span class="sub_total_span">{{@num_format($product->sub_total)}}</span>
                                                <input type="hidden" class="form-control sub_total"
                                                name="add_stock_lines[{{$loop->index}}][sub_total]" value="{{$product->sub_total}}">
                                            </td>
                                            <td>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-3 offset-md-8 text-right">
                                <h3> @lang('lang.total'): <span class="final_total_span">{{@num_format($add_stock->final_total)}}</span> </h3>
                                <input type="hidden" name="final_total" id="final_total" value="{{$add_stock->final_total}}">
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('invoice_no', $add_stock->invoice_no, ['class' => 'form-control', 'placeholder' =>
                                    __('lang.invoice_no')]) !!}
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('transaction_date', @format_date($add_stock->transaction_date), ['class' => 'form-control datepicker', 'required',
                            ...
                            <div class="col-md-3 payment_fields hide">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('amount', @num_format($add_stock->amount), ['class' => 'form-control', 'placeholder'
                                    => __('lang.amount')]) !!}
                                </div>
                            </div>
                            @php
                            ...
                            <div class="col-md-3 payment_fields hide">
                                <div class="form-group">
                                    {!! Form::label('method', __('lang.payment_type'). ':*', []) !!} {{$transaction_payment->method}}
                            ...
                            <div class="col-md-3 payment_fields hide">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('paid_on', @format_date($transaction_payment->paid_on), ['class' => 'form-control datepicker', 'readonly',
                            ...
                            <div class="col-md-3 not_cash_fields hide">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('ref_number', $transaction_payment->ref_number, ['class' => 'form-control not_cash',
                            ...
                            <div class="col-md-3 not_cash_fields hide">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bank_deposit_date', @format_date($transaction_payment->bank_deposit_date), ['class' => 'form-control not_cash datepicker', 'readonly',
                            ...
                            <div class="col-md-3 not_cash_fields hide">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('bank_name', $transaction_payment->bank_name, ['class' => 'form-control not_cash',
                            ...
                            <div class="col-md-3 due_fields hide">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('due_date', !empty($add_stock->due_date) ? @format_date($add_stock->due_date) : null, ['class' => 'form-control datepicker', 'readonly',
