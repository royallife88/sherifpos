...
<tr class="variant_store_prices_{{$row_id}}">
    ...
    <td colspan="4">
        ...
        <input type="hidden" class="form-control" name="variations[{{$row_id}}][variant_stores][{{$store->id}}][store_id]"
            value="{{$store->id}}">
        <input type="text" class="form-control" style="width: 200px;" name="variations[{{$row_id}}][variant_stores][{{$store->id}}][price]"
