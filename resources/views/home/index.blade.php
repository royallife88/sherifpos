            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="wrapper count-title text-center">
                        ...
                        <div class="count-number sell_return-data">{{@num_format($dashboard_data['sell_return'])}}</div>
                    </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                    <div class="wrapper count-title text-center">
                        ...
                        <div class="name"><strong style="color: #00c689">@lang('lang.purchase_return')</strong></div>
                ...
                <div class="col-sm-3">
                    <div class="wrapper count-title text-center">
                        ...
                        <div class="name"><strong style="color: #297ff9">@lang('lang.profit')</strong></div>
    ...
    $(".date-btn").on("click", function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $(".purchase_return-data").text(__currency_trans_from_en(result.purchase_return, false));
