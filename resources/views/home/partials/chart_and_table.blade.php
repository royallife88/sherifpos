    ...
    <div class="col-md-7">
        <div class="card">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" href="#sale-latest" role="tab" data-toggle="tab">@lang('lang.sale')</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#purchase-latest" role="tab" data-toggle="tab">@lang('lang.purchase')</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#payment-latest" role="tab" data-toggle="tab">@lang('lang.payments')</a>
                </li>
            </ul>
