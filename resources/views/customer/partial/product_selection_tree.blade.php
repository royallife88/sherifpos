...
<button type="button" class="btn btn-primary" data-toggle="modal"
    data-target="#pctModal{{ $index }}{{ $key }}" style="margin-top: 30px;">
...
@endphp
<div class="modal fade" id="pctModal{{ $index }}{{ $key }}" tabindex="-1" role="dialog"
    aria-labelledby="pctModalLabel" aria-hidden="true">
                                                                    ...
                                                                    <div class="accordion-inner">
                                                                        ...
                                                                        @foreach ($sub_categories as $sub_category)
                                                                            <div class="accordion"
                                                                                ...
                                                                                style="margin-left: 20px;">
                                                                                <div
                                                                                    class="accordion-group  sub_category_level level">
                                                                                    <div class="row">
                                                                                        <input
