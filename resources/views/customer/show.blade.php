        ...
        <div class="card-body">
            <div class="col-md-12">
                <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link @if(request()->show == 'sizes') active @endif" href="#store-sizes" role="tab"
                            data-toggle="tab">@lang('lang.sizes')</a>
                    </li>
                    @endif
                        ...
                        <table class="table dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if($sale->transaction_payments->count() >
                                        0){{@format_date($sale->transaction_payments->last()->paid_on)}} @endif</td>
                                    ...
                                    <td>@if($sale->transaction_payments->count() >
                                        0){{$sale->transaction_payments->last()->created_by_user->name}} @endif</td>
                                    <td>
                                        <div class="btn-group">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default"
                                                user="menu">
                                                @can('product_module.customer_size.view')
                                                <li>
