...
<div class="row">
    ...
    <div class="col-md-4" style="margin-top: 40px;">
        <div class="i-checks">
            <input id="automatic_consumption" name="automatic_consumption" type="checkbox" @if(!empty($recent_product)
                && $recent_product->automatic_consumption == 1) checked @endif value="1" class="form-control-custom">
