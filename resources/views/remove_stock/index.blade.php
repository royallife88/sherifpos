            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a data-href="{{action('GeneralController@viewUploadedFiles', ['model_name' => 'Transaction', 'model_id' => $remove_stock->id, 'collection_name' => 'remove_stock'])}}"
                            ...
                            class="btn btn-danger btn-modal text-white">@lang('lang.view')</a></td>
                    <td>
                        @if(!empty($remove_stock->add_stock_id)){{App\Models\Transaction::find($remove_stock->add_stock_id)->invoice_no }}@endif
                    </td>
                    <td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a data-href="{{action('RemoveStockController@show', $remove_stock->id)}}" class="btn-modal" data-container=".view_modal"><i
