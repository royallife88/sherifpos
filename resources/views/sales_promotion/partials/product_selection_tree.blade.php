                        ...
                        <div class="card-header align-items-center">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    __('lang.search_product'), 'id' => 'search_pci']) !!}
                                ...
                                <div class="accordion-group class_level level">
                                    <div class="row">
                                        <input id="product_class_selected{{$class->id}}"
                                            name="product_condition_items[product_class_selected][]" type="checkbox" value="{{$class->id}}"
                                                ...
                                                <div class="accordion-group  category_level level">
                                                    <div class="row">
                                                        <input id="category_selected{{$category->id}}"
                                                            name="product_condition_items[category_selected][]" type="checkbox"
                                                                ...
                                                                <div class="accordion-group  sub_category_level level">
                                                                    <div class="row">
                                                                        <input
                                                                            ...
                                                                            name="product_condition_items[sub_category_selected][]"
                                                                            type="checkbox"
                                                ...
                                                <div class="accordion-group  product_level level">
                                                    <div class="row">
                                                        <input id="product_selected{{$product->id}}"
                                                            name="product_condition_items[product_selected][]" type="checkbox"
